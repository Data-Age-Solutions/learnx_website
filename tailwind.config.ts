...
const config: Config = {
  ...
  theme: {
    extend: {
      fontFamily: {
        // Bound to the Inter instance loaded in app/layout.tsx. Without this
        // mapping, `font-sans` falls through to the default system stack and
        // the downloaded Inter file is never actually used.
